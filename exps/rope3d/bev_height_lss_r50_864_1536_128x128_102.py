...
class BEVHeightLightningModel(LightningModule):
    ...
    def training_step(self, batch):
        ...
        #     summary(self.model, input_data=[sweep_imgs, mats, radarData])
        #     # stat(self.model, input_size=[sweep_imgs, mats, radarData])
        #     flops, param = profile(self.model, inputs=[sweep_imgs, mats, radarData])
        #     flops, param = clever_format([flops, param], "%.3f")
        #     print("#"*10)
        #     print(flops, param)
        #     # print("FLOPs: % .4fG"%(Flops / 1000000000))
        #     # print("Params: % .4fM"% (param / 1000000))
        #     input()
        #     self.summary = True
...
def run_cli():
    ...
    parent_parser.add_argument('--resume_from', type=str, help='path to checkpoint to resume training from')  # 新增resume参数
