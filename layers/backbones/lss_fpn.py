...
class HeightNet(nn.Module):
    ...
    def forward(self, x, mats_dict):
        ...
        # print("height.shape", height.shape) # [1, 180, 54, 96]
        # input("PAUSE")
        # torch.save(height, "/john/height.pt")
        # input("PAUSE")
...
class LSSFPN(nn.Module):
    ...
    def _forward_single_sweep(self,
        ...
        # print("height_feature:", height_feature.shape)
        height = height_feature[:, :self.height_channels].softmax(1)
        # print("height:", height.shape) # [1, 180, 54, 96]
        # torch.save(height, "/john/testHeight.pt")
        # input("PAUSE testHeight")
    ...
    def forward(self,
        ...
        if num_sweeps == 1:
            # return BEV feature map
            # 所以要在這邊加上radar bev feature map
            #print("key_frame_res.shape:", key_frame_res.shape) # [1, 80, 128, 128]
            #input("PAUSE")
